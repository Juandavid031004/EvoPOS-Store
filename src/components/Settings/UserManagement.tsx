...
const permisosList: { value: Permission; label: string; category: string }[] = [
  ...
  { value: 'anular_venta', label: 'Anular Ventas', category: 'Ventas' },
  ...
  { value: 'modificar_precios', label: 'Modificar Precios', category: 'Productos' },
  { value: 'gestionar_almacen', label: 'Gestionar Almacén', category: 'Productos' },
  { value: 'gestionar_devoluciones', label: 'Gestionar Devoluciones', category: 'Productos' },
  { value: 'ajustar_stock', label: 'Ajustar Stock', category: 'Productos' },
  { value: 'transferir_stock', label: 'Transferir Stock', category: 'Productos' },
  ...
  { value: 'eliminar_proveedores', label: 'Eliminar Proveedores', category: 'Proveedores' },
  { value: 'gestionar_pedidos', label: 'Gestionar Pedidos', category: 'Proveedores' },
  { value: 'ver_pedidos', label: 'Ver Pedidos', category: 'Proveedores' },
  { value: 'actualizar_pedidos', label: 'Actualizar Pedidos', category: 'Proveedores' },
  { value: 'eliminar_pedidos', label: 'Eliminar Pedidos', category: 'Proveedores' },
  ...
  { value: 'gestionar_deudas', label: 'Gestionar Deudas', category: 'Clientes' },
  { value: 'gestionar_puntos', label: 'Gestionar Puntos', category: 'Clientes' },
  
  // Reportes y Dashboard
  { value: 'ver_reportes', label: 'Ver Reportes', category: 'Reportes' },
  { value: 'exportar_reportes', label: 'Exportar Reportes', category: 'Reportes' },
  { value: 'ver_dashboard', label: 'Ver Dashboard', category: 'Reportes' },
  { value: 'ver_estadisticas', label: 'Ver Estadísticas', category: 'Reportes' },
  ...
  { value: 'eliminar_gastos', label: 'Eliminar Gastos', category: 'Administración' },
  { value: 'ver_configuracion', label: 'Ver Configuración', category: 'Administración' },
  { value: 'configurar_sistema', label: 'Configurar Sistema', category: 'Administración' }
];
